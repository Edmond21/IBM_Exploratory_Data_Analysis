...
Improving the areas listed for the specific level of employee might reduce job attrition for IBM.  IBM could save a lot of money by collecting more data regarding environmental satisfication, entry level employment, marital status, employee stock option level, and working overtime.  These job areas could be improved with more data, which in turn would help IBM save a lot of money and improve their profit margins.
